...
-- #DATA SERVER
INSERT INTO server (ID_Server, IP_Address, server_type) VALUES
(1, '10.234.44.106', 'APP'),
(2, '10.234.44.101', 'APP'),
(3, '10.234.44.82', 'APP'),
(4, '10.234.44.104', 'APP'),
...
(8, '10.234.44.119', 'DB'),
(9, '10.234.44.86', 'DB'),
(10, '10.234.44.102:22', 'DB'),
(11, '10.234.44.118', 'DB'),
(12, '10.234.44.122', 'DB'),
(13, '10.234.44.123', 'DB'),
(14, '10.234.44.120', 'DB');
SELECT setval('server_id_server_seq', (SELECT MAX(ID_Server) FROM server));


-- #DATA SERVER PATH
INSERT INTO server_path (ID_Server, ID_Server_path, Path) VALUES
(1, 1, '/backups'),
(2, 2, '/backups'),
(3, 3, '/backup'),
(4, 4, '/home'),
...
(13, 13, '/'),
(14, 14, '/');
SELECT setval('server_path_id_server_path_seq', (SELECT MAX(ID_Server_path) FROM server_path));


-- #DATA SERVER BACKUP 

INSERT INTO server_backup (ID_Server, ID_Server_Backup, Directory) VALUES
(1, 1, '/backups/ATM116'),
(2, 2, '/backups/BPIH116'),
(3, 3, '/backups/pymaceh/'),
(4, 4, '/home/collega/backup/cms_corp'),
...
(14, 14, '/home/web116/apache-apikey-7070/log'),
(1, 15, '/home/web116/apache-emwares-key-5050/log'),
(1, 16, '/home/db2inst1/dbpinpad'),
(2, 17, '/backup/'),
(3, 18, '/home/postgres/backupdb');
SELECT setval('server_backup_id_server_backup_seq', (SELECT MAX(ID_Server_Backup) FROM server_backup));
...
INSERT INTO server_port (id_server_port, port) VALUES
(1, 8080),
(2, 8000),
(3, 8101);
SELECT setval('server_port_id_server_port_seq', (SELECT MAX(id_server_port) FROM server_port));

INSERT INTO server_config (id_server_config, id_server, id_server_port, id_subproduct) VALUES
(1, 1, 1, 1),
(2, 2, 2, 2),
(3, 1, 3, 3),
(4, 2, 1, 4);
SELECT setval('server_config_id_server_config_seq', (SELECT MAX(id_server_config) FROM server_config));
...
VALUES ('DISETUJUI', 1, 1, 1, 'All tasks completed', '2024-07-17', '05:01:00');
INSERT INTO EVENT_MONITORING (APPROVAL_STATUS, ID_MONITORING, ID_OPERATOR, ID_SUPERVISOR, OPERATOR_NOTES, DATE_MON, TIME_MON)
VALUES ('DITOLAK', 2, 2, 2, 'THERE IS SOME ERROR', '2024-07-17', '10:20:00');
INSERT INTO EVENT_MONITORING (APPROVAL_STATUS, ID_MONITORING, ID_OPERATOR, ID_SUPERVISOR, OPERATOR_NOTES, DATE_MON, TIME_MON)
VALUES ('MENUNGGU PERSETUJUAN', 3, 3, 3, 'All tasks completed', '2024-07-17', '16:12:00');
INSERT INTO EVENT_MONITORING (APPROVAL_STATUS, ID_MONITORING, ID_OPERATOR, ID_SUPERVISOR, OPERATOR_NOTES, DATE_MON, TIME_MON)
VALUES ('MENUNGGU PERSETUJUAN', 4, 3, 3, 'All tasks completed', '2024-07-17', '16:12:00');
...
INSERT INTO MODULE_MONITORING (ID_MODULE_MON, ID_MODULE, ID_DTL_MON,  STATUS, OPERATOR_NOTES, PERFORMA, LOG)
VALUES (1, 1, 1, 'OK', 'Module running smoothly', '<=2 DETIK', 'No issues detected');
INSERT INTO MODULE_MONITORING (ID_MODULE_MON, ID_MODULE, ID_DTL_MON,  STATUS, OPERATOR_NOTES, PERFORMA, LOG)
VALUES (2, 2, 2,  'OK', 'Module running smoothly', '<=2 DETIK', 'No issues detected');
INSERT INTO MODULE_MONITORING (ID_MODULE_MON, ID_MODULE, ID_DTL_MON,  STATUS, OPERATOR_NOTES, PERFORMA, LOG)
VALUES (3, 3, 3,  'NOK', 'THERE ARE SOME PROBLEM', '>=5 DETIK', 'No issues detected');
INSERT INTO MODULE_MONITORING (ID_MODULE_MON, ID_MODULE, ID_DTL_MON,  STATUS, OPERATOR_NOTES, PERFORMA, LOG)
VALUES (4, 4, 4,  'OK', 'Module running smoothly', '<=2 DETIK', 'No issues detected');
INSERT INTO MODULE_MONITORING (ID_MODULE_MON, ID_MODULE, ID_DTL_MON,  STATUS, OPERATOR_NOTES, PERFORMA, LOG)
VALUES (5, 5, 5,  'OK', 'Module running smoothly', '<=2 DETIK', 'No issues detected');
INSERT INTO MODULE_MONITORING (ID_MODULE_MON, ID_MODULE, ID_DTL_MON,  STATUS, OPERATOR_NOTES, PERFORMA, LOG)
VALUES (6, 6, 6,  'OK', 'Module running smoothly', '<=2 DETIK', 'No issues detected');
INSERT INTO MODULE_MONITORING (ID_MODULE_MON, ID_MODULE, ID_DTL_MON,  STATUS, OPERATOR_NOTES, PERFORMA, LOG)
VALUES (7, 7, 7,  'OK', 'Module running smoothly', '<=2 DETIK', 'No issues detected');
INSERT INTO MODULE_MONITORING (ID_MODULE_MON, ID_MODULE, ID_DTL_MON,  STATUS, OPERATOR_NOTES, PERFORMA, LOG)
VALUES (8, 8, 8,  'OK', 'Module running smoothly', '<=2 DETIK', 'No issues detected');
INSERT INTO MODULE_MONITORING (ID_MODULE_MON, ID_MODULE, ID_DTL_MON,  STATUS, OPERATOR_NOTES, PERFORMA, LOG)
VALUES (9, 9, 9,  'OK', 'Module running smoothly', '<=2 DETIK', 'No issues detected');
INSERT INTO MODULE_MONITORING (ID_MODULE_MON, ID_MODULE, ID_DTL_MON,  STATUS, OPERATOR_NOTES, PERFORMA, LOG)
VALUES (10, 10, 8,  'OK', 'Module running smoothly', '<=2 DETIK', 'No issues detected');
INSERT INTO MODULE_MONITORING (ID_MODULE_MON, ID_MODULE, ID_DTL_MON,  STATUS, OPERATOR_NOTES, PERFORMA, LOG)
VALUES (11, 11, 6,  'OK', 'Module running smoothly', '<=2 DETIK', 'No issues detected');
SELECT setval('module_monitoring_id_module_mon_seq', (SELECT MAX(ID_MODULE_MON) FROM MODULE_MONITORING));

-- #DATA SERVER MON
INSERT INTO SERVER_MONITORING (ID_SERVER_MON, ID_SERVER, ID_DTL_MON, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG) VALUES 
(1, 1, 1, 60, 65, 30, 'OK', 'NORMAL'),
 (2, 2, 2, 70, 75, 40, 'NOK', 'CPU IS HIGH'),
 (3, 3, 3, 65, 70, 32, 'OK', 'NORMAL'),
 (4, 4, 4, 60, 65, 33, 'OK', 'NORMAL'),
 (5, 5, 5, 60, 65, 33, 'OK', 'NORMAL'),
 (6, 6, 6, 60, 65, 33, 'OK', 'NORMAL'),
 (7, 7, 7, 60, 65, 33, 'OK', 'NORMAL'),
 (8, 8, 8, 60, 65, 33, 'OK', 'NORMAL'),
 (9, 9, 9, 60, 65, 33, 'OK', 'NORMAL');
SELECT setval('server_monitoring_id_server_mon_seq', (SELECT MAX(ID_SERVER_MON) FROM SERVER_MONITORING));
...
-- INSERT INTO SERVER_DB_MONITORING (ID_SERVER_DB_MON, ID_DTL_MON, ID_SERVER_DB, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG)
-- VALUES (2, 2, 2, 70, 75, 40, 'NOK', 'CPU IS HIGH');
-- INSERT INTO SERVER_DB_MONITORING (ID_SERVER_DB_MON, ID_DTL_MON, ID_SERVER_DB, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG)
-- VALUES (3, 3, 3, 65, 70, 32, 'OK', 'NORMAL');
-- INSERT INTO SERVER_DB_MONITORING (ID_SERVER_DB_MON, ID_DTL_MON, ID_SERVER_DB, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG)
-- VALUES (4, 4, 4, 65, 70, 32, 'OK', 'NORMAL');
-- INSERT INTO SERVER_DB_MONITORING (ID_SERVER_DB_MON, ID_DTL_MON, ID_SERVER_DB, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG)
-- VALUES (5, 5, 5, 65, 70, 32, 'OK', 'NORMAL');
-- INSERT INTO SERVER_DB_MONITORING (ID_SERVER_DB_MON, ID_DTL_MON, ID_SERVER_DB, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG)
-- VALUES (6, 6, 6, 65, 70, 32, 'OK', 'NORMAL');
-- INSERT INTO SERVER_DB_MONITORING (ID_SERVER_DB_MON, ID_DTL_MON, ID_SERVER_DB, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG)
-- VALUES (7, 7, 7, 65, 70, 32, 'OK', 'NORMAL');
-- INSERT INTO SERVER_DB_MONITORING (ID_SERVER_DB_MON, ID_DTL_MON, ID_SERVER_DB, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG)
-- VALUES (8, 8, 8, 65, 70, 32, 'OK', 'NORMAL');
-- INSERT INTO SERVER_DB_MONITORING (ID_SERVER_DB_MON, ID_DTL_MON, ID_SERVER_DB, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG)
-- VALUES (9, 9, 9, 65, 70, 32, 'OK', 'NORMAL');
-- INSERT INTO SERVER_DB_MONITORING (ID_SERVER_DB_MON, ID_DTL_MON, ID_SERVER_DB, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG)
-- VALUES (10, 3, 1, 65, 70, 32, 'OK', 'NORMAL');
-- INSERT INTO SERVER_DB_MONITORING (ID_SERVER_DB_MON, ID_DTL_MON, ID_SERVER_DB, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG)
-- VALUES (11, 2, 1, 65, 70, 32, 'OK', 'NORMAL');
-- INSERT INTO SERVER_DB_MONITORING (ID_SERVER_DB_MON, ID_DTL_MON, ID_SERVER_DB, RAM_USAGE, CPU_USAGE, DISK_USAGE, OPERATOR_NOTES, LOG)
-- VALUES (12, 1, 3, 60, 65, 33, 'OK', 'NORMAL');
-- SELECT setval('server_db_monitoring_id_server_db_mon_seq', (SELECT MAX(ID_SERVER_DB_MON) FROM SERVER_DB_MONITORING));


-- #DATA SERVER_PATH_MONITORING
INSERT INTO SERVER_PATH_MONITORING (id_server_path_mon, ID_DTL_MON, ID_SERVER_PATH, USAGE)VALUES 
(1, 1, 1, 50),
(2, 1, 3, 60),
(3, 2, 2, 20),
(4, 2, 1, 80),
...
(13, 7, 8, 80),
(14, 8, 5, 80);
SELECT setval('SERVER_PATH_MONITORING_id_server_path_mon_seq', (SELECT MAX(id_server_path_mon) FROM SERVER_PATH_MONITORING));
...
-- #DATA BACKUP APP MON
INSERT INTO server_backup_monitoring (id_server_backup_mon, id_server_backup, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)VALUES
(1, 1, 1, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE'),
(2, 2, 2, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE'),
(3, 3, 3, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE'),
(4, 4, 4, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE'),
(5, 5, 5, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE'),
(6, 6, 6, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE'),
(7, 7, 7, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE'),
(8, 8, 8, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE');
SELECT setval('server_backup_monitoring_id_server_backup_mon_seq', (SELECT MAX(id_server_backup_mon) FROM server_backup_monitoring));
-- INSERT INTO BACKUP_APP_MONITORING (ID_BACKUP_APP_MON, ID_BACKUP_APP, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- INSERT INTO BACKUP_APP_MONITORING (ID_BACKUP_APP_MON, ID_BACKUP_APP, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- INSERT INTO BACKUP_APP_MONITORING (ID_BACKUP_APP_MON, ID_BACKUP_APP, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- INSERT INTO BACKUP_APP_MONITORING (ID_BACKUP_APP_MON, ID_BACKUP_APP, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- INSERT INTO BACKUP_APP_MONITORING (ID_BACKUP_APP_MON, ID_BACKUP_APP, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
...
-- #DATA BACKUP DB MON
-- INSERT INTO BACKUP_DB_MONITORING (ID_BACKUP_DB_MON, ID_BACKUP_DB, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- VALUES (1, 1, 1, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE');
-- INSERT INTO BACKUP_DB_MONITORING (ID_BACKUP_DB_MON, ID_BACKUP_DB, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- VALUES (2, 2, 2, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE');
-- INSERT INTO BACKUP_DB_MONITORING (ID_BACKUP_DB_MON, ID_BACKUP_DB, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- VALUES (3, 3, 3, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE');
-- INSERT INTO BACKUP_DB_MONITORING (ID_BACKUP_DB_MON, ID_BACKUP_DB, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- VALUES (4, 1, 4, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE');
-- INSERT INTO BACKUP_DB_MONITORING (ID_BACKUP_DB_MON, ID_BACKUP_DB, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- VALUES (5, 2, 5, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE');
-- INSERT INTO BACKUP_DB_MONITORING (ID_BACKUP_DB_MON, ID_BACKUP_DB, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- VALUES (6, 3, 6, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE');
-- INSERT INTO BACKUP_DB_MONITORING (ID_BACKUP_DB_MON, ID_BACKUP_DB, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- VALUES (7, 1, 7, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE');
-- INSERT INTO BACKUP_DB_MONITORING (ID_BACKUP_DB_MON, ID_BACKUP_DB, ID_DTL_MON, STATUS, start_backup, finish_backup, OPERATOR_NOTES)
-- VALUES (8, 2, 8, 'OK', '05:01:00', '05:02:00', 'BACKUP DONE');
